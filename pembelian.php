...
<tbody>
    ...
    while ($d = mysqli_fetch_array ($data)) {
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-infp btn-sm" href="detail_pembelian.php?PelangganID=<?php echo $d ['PelangganID']; ?>">Detail</a>
                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit-data<?php echo $d ['PelangganID']; ?>">
                    Edit 
    </button>
    <button> type="button" cladd="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus-data<?php echo $d ['PelangganID']; ?>">
                    Hapus 
   </button>
    </td>
    </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <button type="button" class="byn-close" data-bs-dissmiss="modal" aria-label="Close"></button>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="NamaPelanggan" value="<?php echo $d['Namaelanggan']; ?>" class="form-control">
    </div>
    <div class="form-group">
...
<form method="post" action="proses hapus pembelian.php"> <div class="modal-body">
<input type="hidden" name="PelangganID" value="<?php echo $d['PelangganID']; ?>">
Apakah anda yakin akan menghapus data <b><?php echo $d['Nama Pelanggan']; ?></b>
</div>
<div class="modal-footer">
...
<input type="text" name="PelangganIDinput" value="<?php echo time()- date("z"); ?>" class="form-control" readonly>
</div>
<div class="form-group">
...
<div class="form-group">
<label>No. Telepon</label>
<input type="text" name="Nomor Telepon" class="form-control">
</div>
<div class="form-group">
<label>Alamat</label>
